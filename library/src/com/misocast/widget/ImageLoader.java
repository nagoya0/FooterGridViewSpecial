...
public class ImageLoader {
    ...
    public void getBitmap(GridItem image,
    ...
    public boolean cancel(final GridItem image) {
        synchronized (mQueue) {
    ...
    private int findItem(GridItem image) {
    ...
    private static class WorkItem {
        ...
        WorkItem(GridItem image, LoadedCallback onLoadedRunnable, int tag) {
            mImage = image;
    ...
    private class WorkerThread implements Runnable {
        ...
        public void run() {
            while (true) {
                ...
                final Bitmap b = workItem.mImage.getBitmapInBackground(workItem.mTag);
    ...
    protected void onDecodeThreadCancel(Thread t, ContentResolver cr) {
        // finalize decode thread in this
    }
}
